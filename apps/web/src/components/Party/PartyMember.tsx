  ...
  return (
    <div className="flex flex-col">
      ...
      <button
        ...
        className={`w-full flex items-center justify-between py-2 rounded transition-colors ${
      ...
      >
        <div className="flex items-center gap-3">
          <div
            className="w-8 h-8 rounded-full bg-ash/20 flex items-center justify-center font-bold"
          ...
          {user?.id !== member.userId && (
            <div className="flex items-center gap-1">
              ...
              <button
                ...
                className={`w-8 h-8 flex shrink-0 items-center justify-center transition-colors hover:bg-ash/10 rounded ${
                  isLocallyMuted ? 'text-red-400/80 hover:text-red-400' : 'text-paper/60 hover:text-paper'
                }`}
